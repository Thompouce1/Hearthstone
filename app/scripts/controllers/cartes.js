...
angular.module('app1App')
  .controller('CartesCtrl', function ($scope, $http) {
	...
	$scope.normale = 'http://wow.zamimg.com/images/hearthstone/cards/frfr/original/GAME_005.png';
	$scope.doree = 'http://wow.zamimg.com/images/hearthstone/cards/frfr/animated/GAME_005_premium.gif';
	
	$scope.searchCardbyName = function(cardName) {
		$http.get("https://omgvamp-hearthstone-v1.p.mashape.com/cards/search/" + cardName + "?collectible=1&locale=frFR", {
	...
	$http.get("https://omgvamp-hearthstone-v1.p.mashape.com/cards/qualities/" + rarity  + "?collectible=1&locale=frFR", {
		headers:{'X-Mashape-Key': '672QlplWjFmshPlkfuF4aUc4I0AQp1yTdYdjsnO32n5laZ84tC' }
			}).success(function(data) {
				$scope.currentCard = data;
			});
	...
	$http.get("https://omgvamp-hearthstone-v1.p.mashape.com/cards/sets/" + set  + "?collectible=1&locale=frFR", {
		headers:{'X-Mashape-Key': '672QlplWjFmshPlkfuF4aUc4I0AQp1yTdYdjsnO32n5laZ84tC' }
			}).success(function(data) {
				$scope.currentCard = data;
			});
