...
angular.module('app1App')
  .controller('ClasseDeckBuilderCtrl', function($scope, $http){
	...
	$scope.un = 'http://wow.zamimg.com/images/hearthstone/cards/enus/original/GAME_005.png';
	$scope.deux = 'http://wow.zamimg.com/images/hearthstone/cards/enus/original/GAME_005.png';
	$scope.trois = 'http://wow.zamimg.com/images/hearthstone/cards/enus/original/GAME_005.png';
	$scope.quatre = 'http://wow.zamimg.com/images/hearthstone/cards/enus/original/GAME_005.png';
	$scope.cinq = 'http://wow.zamimg.com/images/hearthstone/cards/enus/original/GAME_005.png';
	$scope.six = 'http://wow.zamimg.com/images/hearthstone/cards/enus/original/GAME_005.png';
